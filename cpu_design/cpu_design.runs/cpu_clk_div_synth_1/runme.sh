...
HD_PWD='C:/Users/12644/Desktop/cpu_design/cpu_design.runs/cpu_clk_div_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cpu_clk_div.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cpu_clk_div.tcl
