...
HD_PWD='C:/Users/12644/Desktop/cpu_pipeline_suspend/cpu_pipeline_suspend.runs/cpu_clk_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cpu_clk.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cpu_clk.tcl
